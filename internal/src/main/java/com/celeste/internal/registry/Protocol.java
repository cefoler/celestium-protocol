...
public final class Protocol {
  ...
  public static AbstractPacket<? extends PacketContent> getPacketInbound(final ConnectionState stage, final int packetId) {
    return switch (stage) {
  ...
  public static AbstractPacket<? extends PacketContent> getPacketOutbound(final ConnectionState stage, final int packetId) {
    return switch (stage) {
      case HANDSHAKE -> new HandshakePacket();
  ...
  public static AbstractPacket<? extends PacketContent> getPacketOutbound(final ConnectionState state, final Class<? extends PacketContent> packet) {
    return switch (state) {
